...
use BytePlatform\Admin\Menu\MenuItemBuilder;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function packageBooted()
    {
        ...
        SettingForm::Register(function (\BytePlatform\Admin\ItemManager $form) {
        ...
        Menu::Register(function () {
            if (byte_is_admin()) {
                Menu::route('admin.dashboard', __('admin::sidebars.dashboard'), '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-dashboard" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                <path d="M12 13m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
                <path d="M13.45 11.55l2.05 -2.05"></path>
                <path d="M6.4 20a9 9 0 1 1 11.2 0z"></path>
             </svg>', [], '', 1);
                menu::subMenu(__('admin::sidebars.user'), '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-shield" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                ...
                <path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"></path>
                    ...
                    $menu->route(['name' => 'admin.user-list', 'params' => []], __('admin::sidebars.user'), '', [], 'admin.user-list');
                    $menu->route(['name' => 'admin.role-list', 'params' => []], __('admin::sidebars.role'), '', [], 'admin.role-list');
                    $menu->route(['name' => 'admin.permission-list', 'params' => []], __('admin::sidebars.permission'), '', [], 'admin.permission-list');
                }, 9999999999999);
                menu::subMenu(__('admin::sidebars.appearance'), '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brush" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
